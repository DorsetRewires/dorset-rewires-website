...
const VERSION = 'sv-941261c0';
const SHELL_CACHE = 'dorset-rewires-shell-' + VERSION;
const RUNTIME_CACHE = 'dorset-rewires-runtime-' + VERSION;

const SHELL = [
  '/quote.html',
  '/assets/css/quote.css?v=941261c0',
  '/assets/js/dr-config.js?v=941261c0',
  '/assets/js/quote-calculator-logic.js?v=941261c0',
  '/assets/css/styles.css?v=941261c0',
  '/assets/js/script.js?v=941261c0',
  '/assets/js/reviews-carousel.js?v=941261c0',
  '/manifest.json',
